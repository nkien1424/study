...
public class UserController {
    ...
    @Autowired
    private User_ExamRepository examRepository;
    @Autowired
    ...
    public String profile(Model model) {
        ...
        model.addAttribute("exams",examRepository.findAllByUser_Id(Integer.valueOf(auth.getName())));
...
//    }
    ...
    String createUser(@ModelAttribute UserRequest user, RedirectAttributes redirectAttributes,Model model) {
        try {
    ...
    ResponseEntity<?> changePassword(@RequestBody ChangePasswordRequest request, RedirectAttributes redirectAttributes, Model model) {
        Authentication auth = SecurityContextHolder.getContext().getAuthentication();
        User user = userRepository.findUserById(Integer.valueOf(auth.getName()));
